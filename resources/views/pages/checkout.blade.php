              ...
              <div class="attendee">
                <table class="table table-responsive-sm text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>
                          <img src="https://ui-avatars.com/api/?name={{$detail->username}}" alt="avatar" height="60" class="rounded-circle">
                        </td>
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <table class="trip-information">
                <tr>
                  <th witdh ="50%"> Members</th>
                  <td witdh ="50%" class="text-right"> {{$item->details->count()}} person</td>
                </tr>
                <tr>
                  <th witdh ="50%"> Additional VISA</th>
                  <td witdh ="50%" class="text-right"> $ {{ $item->additional_visa}},00</td>
                </tr>
                <tr>
                  <th witdh ="50%"> Trip Price</th>
                  <td witdh ="50%" class="text-right"> $ {{$item->travel_package->price}},00 / person</td>
                </tr>
                <tr>
                  <th witdh ="50%"> Sub Total</th>
                  <td witdh ="50%" class="text-right"> $ {{$item->transaction_total}},00</td>
                </tr>
                <tr>
                  <th witdh ="50%"> Total (+Unique Code)</th>
                  <td witdh ="50%" class="text-right text total">
              ...
              <div class="bank">
                ...
                <img src="{{url('frontend/images/ic_bank.png')}}" alt="ic_bank" class="bank-image">
